...
import { Upload, Image, Video, AlertCircle, CheckCircle, XCircle, Eye, Shield, Zap } from 'lucide-react';
    ...
    <section className="max-w-4xl mx-auto">
      ...
      >
        ...
        <p className="text-xl text-white/80 max-w-2xl mx-auto">
          Upload an image or video to detect potential deepfakes and manipulation.
        </p>
      </motion.div>
            ...
            <div className="flex flex-col items-center space-y-6">
              ...
              <div>
                ...
                <p className="text-white/70 mb-6">
                  or choose a file type to browse
                </p>
                
                {/* --- TWO BUTTONS FOR UPLOAD --- */}
                <div className="flex justify-center space-x-4">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    onClick={() => imageInputRef.current?.click()}
                    className="bg-white text-indigo-600 px-6 py-3 rounded-full font-semibold hover:bg-white/90 transition-colors duration-200 flex items-center space-x-2"
                  >
                  ...
                  <motion.button
                    ...
                    className="bg-white text-purple-600 px-6 py-3 rounded-full font-semibold hover:bg-white/90 transition-colors duration-200 flex items-center space-x-2"
                  >
              ...
              <p className="text-sm text-white/60">
                Supports JPEG, PNG, GIF, MP4, MOV, WEBM • Max size: 100MB
              </p>
            </div>
                ...
                <div className="text-center mb-8">
                  <div className="flex items-center justify-center space-x-3 mb-4">
                    ...
                    <h3 className="text-3xl font-bold text-gray-800">
                      {result.prediction === 'REAL' ? 'Authentic Media' : 
